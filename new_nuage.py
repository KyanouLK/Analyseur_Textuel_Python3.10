...
# firstpart = first_part_file("Texte/80jours_reduit.txt")
# lastpart = last_part_file("Texte/80jours_reduit.txt")
...
# clean1_fp = cleaner(return_token(firstpart), stopWords)
# clean2_fp = cleaner(clean1_fp, stoppeur)
# clean3_fp = cleaner(clean2_fp, last_stopwords)

# clean1_lp = cleaner(return_token(lastpart), stopWords)
# clean2_lp = cleaner(clean1_lp, stoppeur)
# clean3_lp = cleaner(clean2_lp, last_stopwords)
...
# writer("Texte/firstpart.txt", clean3_fp)
# writer("Texte/lastpart.txt", clean3_lp)
...
# r1 = reader("Texte/firstpart.txt")
# r2 = reader("Texte/lastpart.txt")
